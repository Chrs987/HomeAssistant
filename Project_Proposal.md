...
Our Team GitHub repository can be found [here](https://github.com/Chrs987/HomeAssistant). For our colaboration efforts, we have decided to use a Discord Chat to easily allow voice & chat communication between us. Since discord was widely used by our group already, and easily notifies us when a member reaches out, we have had little problems with getting in contact with eachother and communicating. Together through the discord we have discussed our options for a Project, as well as delicated tasks. The issues we generated from our discussions can be found [here](https://github.com/Chrs987/HomeAssistant/issues) and the related GitHub Project Boards for our project can be found [here](https://github.com/Chrs987/HomeAssistant/projects). Overall our teamwork for this assignment and project thus far has been exemplary. We simply need to keep our momentum going, slowing down on work and communication will effect the project long term. 
